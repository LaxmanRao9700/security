...
public class EmployeeTest {
	...
	public static void main(String[] args) {
		...
		.forEach(System.out::println);
		 System.out.println("-----");
		 EmployeeTest employee=listOfEmployee.stream().sorted(Comparator.comparingDouble(EmployeeTest::getSalary).reversed())
				 .skip(1).findFirst().orElseThrow(()->
				 new NoSuchElementException("Second highest salary not found")
				 );
